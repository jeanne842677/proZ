                                ...
                                <div class="footer-content-wrapper">
                                    <div class="editor-content-cover">
                                        <div class="editor-content-cover-wrapper">
                                            ...
                                            <button class="editor-cover" style="background-color:#f6a9b0;"></button>
                                            <button class="editor-cover" style="background-color:#fee182;"></button>
                                            <button class="editor-cover" style="background-color:#a1d5ae;"></button>
...
$('#editor-submit-btn').on('click' , function() {
    ...
    .then(text=>{
        location.href="/board/${projectIdx}?wsIdx=${board.wsIdx}";
    })
})
</script>
<script type="text/javascript">
