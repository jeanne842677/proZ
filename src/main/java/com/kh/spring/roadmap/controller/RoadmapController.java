package com.kh.spring.roadmap.controller;
...
import com.kh.spring.roadmap.model.service.RoadMapService;
					...
					while (q.size() != 0) {
						...
						for (int j = 0; j < lt.size(); j++) {
							...
							if (lt.get(j).getType().equals("tree")) {
								...
								if(p.equals("test") || p.equals("css") || p.equals("img") || p.equals("js") || p.equals("webfonts")) {
									break;
								}
